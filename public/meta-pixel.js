...
(function () {
  ...
  function mostrarAviso() {
    ...
    css.textContent =
      ...
      'background:#fefefe;color:#1C1C1C;border:1px solid #E6E0D2;border-radius:14px;box-shadow:0 8px 28px rgba(28,28,28,.14);' +
      ...
      '.esc-cookies button{font:inherit;font-weight:500;border-radius:999px;padding:8px 18px;cursor:pointer;border:1px solid #B88F47}' +
    ...
    caixa.innerHTML =
      '<p>Usamos cookies para medir as visitas e mostrar nossos anúncios a quem já conhece este livro. Você pode aceitar ou recusar.</p>' +
